// The following code is a copy of index.js from the extension auto-image-generation for SillyTavern. This is to be used exclusively as a reference on how the implementation can be done inside the rpg-companion-sillytavern extension and nothing else.
